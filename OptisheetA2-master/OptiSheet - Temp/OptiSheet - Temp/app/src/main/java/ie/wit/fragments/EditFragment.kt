...
class EditFragment : Fragment(), AnkoLogger {
    ...
    override fun onCreateView(
        ...
        root.editUpdateButton.setOnClickListener {
            showLoader(loader, "Updating Charactersheet on Server...")
            updateCharactersheetData()
            updateCharactersheet(editSheet!!.uid, editSheet!!)
            updateUserCharactersheet(app.currentUser!!.uid,
    ...
    fun updateUserCharactersheet(userId: String, uid: String?, sheet: SheetModel) {
    ...
    fun updateCharactersheet(uid: String?, sheet: SheetModel) {
