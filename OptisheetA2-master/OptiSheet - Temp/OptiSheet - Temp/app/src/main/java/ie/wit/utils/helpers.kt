...
fun createLoader(activity: FragmentActivity) : AlertDialog {
    ...
    loader.setIcon(R.mipmap.ic_launcher_dragon_round)
...
fun uploadImageView(app: OptiSheetApp, imageView: ImageView) {
...
fun updateAllCharactersheets(app: OptiSheetApp) {
...
fun writeImageRef(app: OptiSheetApp, imageRef: String) {
    val userId = app.currentUser!!.uid
...
fun validatePhoto(app: OptiSheetApp, activity: Activity) {
    ...
    {
        activity.navView.getHeaderView(0).imageView.setImageResource(R.mipmap.ic_launcher_dragon_round)
        uploadImageView(app, activity.navView.getHeaderView(0).imageView)
    }
}

fun checkExistingPhoto(app: OptiSheetApp, activity: Activity) {
