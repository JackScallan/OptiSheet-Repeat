...
import ie.wit.fragments.VaultFragment
...
class Home : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        app = application as OptiSheetApp
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.nav_donate ->
                navigateTo(SheetFragment.newInstance())
            R.id.nav_report ->
                navigateTo(VaultFragment.newInstance())
            R.id.nav_report_all ->
                navigateTo(VaultAllFragment.newInstance())
            R.id.nav_aboutus ->
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.action_donate -> toast("You Selected Charactersheet")
            R.id.action_report -> toast("You Selected Vault")
        }
