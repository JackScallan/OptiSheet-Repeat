...
import ie.wit.R
import ie.wit.adapters.CharactersheetAdapter
import ie.wit.adapters.CharactersheetListener
...
open class VaultFragment : Fragment(), AnkoLogger,
    ...
    override fun onCreateView(
        ...
        root.recyclerView.adapter = CharactersheetAdapter(options, this)

        val swipeDeleteHandler = object : SwipeToDeleteCallback(activity!!) {
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                deleteCharactersheet((viewHolder.itemView.tag as SheetModel).uid)
                deleteUserCharactersheet(app.currentUser!!.uid,
        ...
        val swipeEditHandler = object : SwipeToEditCallback(activity!!) {
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                onCharactersheetClick(viewHolder.itemView.tag as SheetModel)
            }
        }
    ...
    fun deleteUserCharactersheet(userId: String, uid: String?) {
    ...
    fun deleteCharactersheet(uid: String?) {
    ...
    override fun onCharactersheetClick(sheet: SheetModel) {
